...
export const WorkshopAndCourses=()=>{
   ...
   const workshopAndCoursesList = [
      ...
      {
        image: `${process.env.NEXT_PUBLIC_WEBSITE_URL}/workshops/angel-therapy.png`,
        title: 'Angel Therapy',
      ...
      {
        image: `${process.env.NEXT_PUBLIC_WEBSITE_URL}/workshops/pendulum-healing.jpg`,
      ...
      {
        image: `${process.env.NEXT_PUBLIC_WEBSITE_URL}/workshops/self-healing.png`,
        title: 'Self Healing',
      ...
      {
        image: `${process.env.NEXT_PUBLIC_WEBSITE_URL}/workshops/law-of-attraction.png`,
