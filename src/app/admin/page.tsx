...
export default async function Page() {
  return (
    <ProtectedPage>
      <div className="max-w-7xl mx-auto py-4 px-2 flex flex-col items-center">
         ...
         <Link href="/" className="font-semibold mx-auto">Home</Link>
      </div>
      <div className="max-w-7xl gap-8 mx-auto px-8 flex flex-wrap xl:flex-nowrap text-neutral-800 hover:cursor-pointer py-14">
        <BlogInput />
        <BlogsList />
      </div>
    </ProtectedPage>
